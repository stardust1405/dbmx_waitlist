	...
	<Html>
		...
		<Body style={main}>
			<Container style={container}>
				<Img
					src={"https://waitlist.idee8.agency/waitlist-logo.png"}
					width="220"
					height="100"
					alt="Idee8 Waitlist Logo"
					style={logo}
				/>
				<Text style={greeting}>Hi {userFirstname},</Text>
				<Text style={paragraph}>
					Thanks for joining the waitlist for our Next.js + Notion CMS waitlist
					template! We are Idee8, a digital agency that helps businesses grow
					online. We are glad to have you on board.
				</Text>
				<Text style={paragraph}>
					...
					<a href="mailto:irere@idee8.agency" style={link}>
						this email {""}
					</a>
				...
				<Text style={paragraph}>
					...
					<a href="https://x.com/Idee8Agency" style={link}>
						@Idee8Agency
					</a>
				</Text>
				<Text style={signOff}>
